...
aligned_rat_merged <- SetIdent(object = aligned_rat_merged , value = aligned_rat_merged$orig.ident)
all_features <-  FindAllMarkers(aligned_rat_merged, min.pct = 0.25, test.use = "DESeq2",  verbose = T)
...
rat_merged_subcluster_markers <- FindAllMarkers(aligned_rat_merged, min.pct = 0.25, logfc.threshold = 0.25)
